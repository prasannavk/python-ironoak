...
# ArUco declarations
mtx = np.load('/Users/Haviva/code/ArUco-marker-detection-with-DepthAi/datacalib_mtx_webcam.pkl', allow_pickle=True)
dist = np.load('/Users/Haviva/code/ArUco-marker-detection-with-DepthAi/datacalib_dist_webcam.pkl', allow_pickle=True)
    ...
    if frameRight is not None:
        ...
        if tvecs is not None:
            for i in range(len(tvecs)):
                imaxis = cv2.drawFrameAxes(imaxis, mtx, dist, rvecs[i], tvecs[i], length_of_axis)  # changed this and fixed it
